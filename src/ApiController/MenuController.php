...
/**
 * @Rest\Route("/menu", host="api.ojbento.fr")
 */
class MenuController extends AbstractFOSRestController
{
     ...
     * @Rest\View()
     */
    public function index(MenuRepository $menuRepository, SerializerInterface $serializer): View
    {
     ...
     * @Rest\View()
     */
    public function show(Menu $menus): View
    {
        return View::create($menus, Response::HTTP_OK);
    }
