 ...
 */
final class Version20190522111433 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE assoc (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, quantity INT NOT NULL, is_dish TINYINT(1) NOT NULL, description LONGTEXT DEFAULT NULL, composition LONGTEXT DEFAULT NULL, INDEX IDX_7B9337114584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
